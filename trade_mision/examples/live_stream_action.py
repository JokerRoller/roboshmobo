import cv2 as cv
import os
from trade_mision.pictures.Screenshot import testfunction
...
# haystack_img = cv.imread('enlist.png', cv.IMREAD_UNCHANGED)
haystack_img = cv.imread('screen.jpg', cv.IMREAD_UNCHANGED)
needle_img = cv.imread('pictures/mini_blue.png', cv.IMREAD_UNCHANGED)
...
while True:
    ...
    if max_val >= threshold:
        ...
        # target_x = top_left[0] + needle_w / 2
        # target_y = top_left[1] + needle_h / 2
